...
public interface PrintDrawingService {
     ...
     * @return the response containing the list of print drawing DTOs
     */
    public PrintDrawingResponse findByDrawingNameAndDiameterAndFaceLengthBetween(int pageNo, int pageSize,
                                                                                 String sortField, String drawingName,
                                                                                 float diameterMinValue, float diameterMaxValue, float faceLengthMinValue,
